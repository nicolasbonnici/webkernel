...
class Validator
{
     ...
     * @param integer $iMinValue
     *            Minimum value of integer (optional)
     * @param integer $iMaxValue
     *            Maximum value of integer (optional)
     ...
     *
     * @param float $fFloat
     *            Potential float to check
     * @param float $fMinValue
     *            Minimum value of float (optional)
     * @param float $fMaxValue
     *            Maximum value of float (optional)
     * @return integer Check status
     */
     ...
     *            Potential string to check
     * @param string $iMinLength
     *            Minimum length of string (optional)
     * @param string $iMaxLength
     ...
     *
     * @param boolean $bBoolean
     *            Potential boolean to check
     * @return integer Check status
     */
    static public function boolean(&$bBoolean)
    {
        if (! in_array($bBoolean, array(
            true,
            false,
            0,
            1
     ...
     *
     * @param string $sDate
     *            Potential SQL formated date to check
     * @return integer Check status
     */
     ...
     *            Potential SQL formated datetime to check
     * @return integer Check status
     */
     ...
     *
     * @param string $sCivility
     *            Civility
     * @param string $sCountry
     *            Country to check (not every civilities available in all countries)
     * @return integer Check status
     */
    static public function civility(&$sCivility, $sCountry = COUNTRY)
    {
        return in_array($sCivility, array(
            'mr',
            'mme',
            'mlle',
            'none'
    ...
    {
        return (self::string($sGender, 1) === self::STATUS_OK && in_array($sGender, array(
            'male',
            'female',
            'none'
        ))) ? self::STATUS_OK : self::STATUS_INVALID;
